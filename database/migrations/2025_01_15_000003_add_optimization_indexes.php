...
return new class extends Migration
{
    ...
    {
        // Indexes pour la table patronymes (seulement sur les colonnes existantes)
        ...
        // Indexes pour la table users (seulement sur les colonnes existantes)
        Schema::table('users', function (Blueprint $table) {
            // Ces index seront ajoutés après que les colonnes soient créées
