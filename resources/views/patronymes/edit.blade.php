                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="enquete_nom" id="enquete_nom" required
                                        value="{{ old('enquete_nom', $patronyme->enquete_nom) }}"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="number" name="enquete_age" id="enquete_age" min="1" max="120"
                                            value="{{ old('enquete_age', $patronyme->enquete_age) }}"
                                            class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        @error('enquete_age')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <div class="flex space-x-4">
                                            <label class="flex items-center">
                                                <input type="radio" name="enquete_sexe" value="M" {{ old('enquete_sexe', $patronyme->enquete_sexe) == 'M' ? 'checked' : '' }}
                                                    class="mr-2">
                                                Masculin
                                            </label>
                                            <label class="flex items-center">
                                                <input type="radio" name="enquete_sexe" value="F" {{ old('enquete_sexe', $patronyme->enquete_sexe) == 'F' ? 'checked' : '' }}
                                                    class="mr-2">
                                                Féminin
                                            </label>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="enquete_fonction" id="enquete_fonction"
                                        value="{{ old('enquete_fonction', $patronyme->enquete_fonction) }}"
                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="enquete_contact" id="enquete_contact"
                                        value="{{ old('enquete_contact', $patronyme->enquete_contact) }}"
                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="origine" id="origine" rows="3"
                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('origine', $patronyme->origine) }}</textarea>
                                    @error('origine')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2">
                                        <label class="flex items-center">
                                            <input type="radio" name="transmission" value="pere" {{ old('transmission', $patronyme->transmission) == 'pere' ? 'checked' : '' }}
                                                class="mr-2">
                                            a. Père en fils/fille
                                        </label>
                                        <label class="flex items-center">
                                            <input type="radio" name="transmission" value="mere" {{ old('transmission', $patronyme->transmission) == 'mere' ? 'checked' : '' }}
                                                class="mr-2">
                                ...
                                <div>
                                    ...
                                    <select name="patronyme_sexe" id="patronyme_sexe"
                                        ...
                                        <option value="oui" {{ old('patronyme_sexe', $patronyme->patronyme_sexe) == 'oui' ? 'selected' : '' }}>Oui, même patronyme</option>
                                        <option value="non" {{ old('patronyme_sexe', $patronyme->patronyme_sexe) == 'non' ? 'selected' : '' }}>Non, patronymes différents</option>
                                        <option value="autre" {{ old('patronyme_sexe', $patronyme->patronyme_sexe) == 'autre' ? 'selected' : '' }}>Autre à préciser</option>
                                    </select>
                                    ...
                                    <div id="patronyme_sexe_precision" style="display: {{ old('patronyme_sexe', $patronyme->patronyme_sexe) == 'autre' ? 'block' : 'none' }};" class="mt-3">
                                        ...
                                        <textarea name="patronyme_sexe_detail" id="patronyme_sexe_detail" rows="3"
                                            ...
                                            class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('patronyme_sexe_detail', $patronyme->patronyme_sexe_detail ?? '') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="totem" id="totem"
                                        value="{{ old('totem', $patronyme->totem) }}"
                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @error('totem')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <textarea name="justification_totem" id="justification_totem" rows="3"
                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('justification_totem', $patronyme->justification_totem) }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea name="parents_plaisanterie" id="parents_plaisanterie" rows="3"
                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('parents_plaisanterie', $patronyme->parents_plaisanterie) }}</textarea>
                                    ...
                                    <div>
                                        ...
                                        <select name="province_id" id="province_id"
                                            ...
                                            @if($patronyme->province)
                                                <option value="{{ $patronyme->province->id }}" selected>{{ $patronyme->province->nom }}</option>
                                            @endif
                                        </select>
                                        @error('province_id')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select name="commune_id" id="commune_id"
                                        ...
                                        @if($patronyme->commune)
                                            <option value="{{ $patronyme->commune->id }}" selected>{{ $patronyme->commune->nom }}</option>
                                        @endif
                                    </select>
                                    @error('commune_id')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (selectedRegionId) {
            ...
            if (selectedProvinceId) {
                setTimeout(() => loadCommunes(selectedProvinceId, communeSelect.value), 200);
            }
        }
    });
