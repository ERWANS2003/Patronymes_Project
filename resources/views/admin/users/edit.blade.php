...
<head>
    ...
    <title>{{ config('app.name', 'Répertoire des Patronymes') }} - Modifier l'Utilisateur</title>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('role') is-invalid @enderror" id="role" name="role" required>
                                            ...
                                            <option value="contributeur" {{ old('role', $user->role) == 'contributeur' ? 'selected' : '' }}>Contributeur</option>
